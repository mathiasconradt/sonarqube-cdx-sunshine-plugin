...
![Build](https://github.com/mathiasconradt/sonarqube-cdx-sunshine-plugin/actions/workflows/build.yml/badge.svg) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=mathiasconradt_sonarqube-sbom-visualization-plugin&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=mathiasconradt_sonarqube-sbom-visualization-plugin)
